...
author: "`paste('PaRe', packageVersion('DependencyReviewer'))`"
date: "`r Sys.Date()`"
...
>[Cyclometic Complexity](https://en.wikipedia.org/wiki/Cyclomatic_complexity) is a software metric used to indicate the complexity of a program. It is a quantitative measure of the number of linearly independent paths through a program's source code. It was developed by Thomas J. McCabe, Sr. in 1976.
...
### Lintr
```{r echo=params$showCode, message=FALSE, warning=FALSE}
DependencyReviewer::lintScore(DependencyReviewer::lintPackage, params$pkgPath)
```
