---
title: "Vignette: DependencyReviewer"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{getDefaultPermittedPackages}
...
### checkDependencies
#### What does it do?
Now that we have defined our 'whitelisted' packages, `checkDependencies` allows us to check our currently used dependencies against it. `checkDependencies` will run `getDefaultPermittedPackages` internally so there is no need to run the two sperately to check your dependencies against the whitelist.
...
Notice how _"Imports"_ and _"Depends"_ packages of CDMConnector are whitelisted, but _"Suggests"_ packages are not.

### Requesting packages to be whitelisted
If you find that some packages are not yet whitelisted, you can request them to be. The [DependencyReviewerWhitelists](https://github.com/mvankessel-EMC/DependencyReviewerWhitelists) repository on GitHub houses the whitelist for _DependencyReviewer_.
...
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_100800.png")
```
...
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_101030.png")
```
...
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_101612.png")
```

We can then preview our request issue:

```{r, echo=FALSE, out.width="100%", fig.cap="Request preview"}
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_101939.png")
```
...
#### What does it return?
`summariseFunctionUse` returns a class of data.frame with the following columns: **1**) r_file, **1**) line, **1**) pkg, **1**) fun.
...
knitr::include_graphics("D:/Users/mvankessel/Pictures/function_review.png")
```
...
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_132449.png")
```
...
knitr::include_graphics("D:/Users/mvankessel/Pictures/function_review_plot.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="Package review"}
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_133831.png")
```

_base_ packages are now excluded from both the <span style="color:#4472C4">**summariseFunctionUse table and plot**</span>.

```{r, echo=FALSE, out.width="100%", fig.cap="Package review"}
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_134126.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="Package review"}
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_134345.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="Package review"}
knitr::include_graphics("D:/Users/mvankessel/Pictures/Screenshots/Schermafbeelding_20221209_134754.png")
```
...
$$darwinLintScore_{type} = {n_{messages} \over n_{lines}} \times 100 $$
#### What does it need?
